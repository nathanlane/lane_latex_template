...
\begin{itemize}
  ...
  \item \textbf{Typography standards:} See \texttt{API\_REFERENCE.md} for the command reference and typography standards
...
The foundation of this document is a rigorously implemented 13.2pt spacing quantum system, established July 2, 2025. All vertical spacing derives from the quantum, giving professional vertical rhythm throughout the document. (The body baseline measures 16.32pt; see \texttt{docs/adr/0004-baseline-grid-is-a-spacing-quantum.md}.)
...
\item \emph{Spacing Quantum:} 13.2pt rhythm optimized for Pagella
...
\item \emph{Quantum integration:} All vertical spacing derives from the 13.2pt quantum for consistent rhythm
\item \emph{Nested list progression:} Secondary levels use en-dash, tertiary use diamond symbols
  ...
  \item Professional gray coloring continues throughout hierarchy
    ...
    \item Maintains consistent rhythm through all nesting levels
...
\item[Spacing Quantum] A fixed vertical unit (here 13.2pt) from which all template spacing derives, ensuring consistent vertical rhythm
...
\item \emph{Quantum rhythm:} All spacing derives from the 13.2pt quantum
\end{itemize}
