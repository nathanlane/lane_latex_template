...
\safeparagraph{Grid Recovery} After the footnote block, the main text should return perfectly to the baseline grid. The 8.5pt footnote text with 11pt leading aligns to 0.833 gridlines (11pt ÷ 13.2pt), allowing smooth recovery of the main text rhythm.

This final paragraph\footnote{A longer footnote to test hyphenation and justification. The hanging indent is now 11.5pt, sized for three-digit markers, creating optimal proportion with Pagella's generous x-height. Word spacing is optimized at 0.35em for readability at this smaller size.} confirms that the grid is maintained throughout the document.
