...
\hfill--- Matthew Butterick, \textit{Practical Typography}
\end{quote}
...
\hfill--- Robert Bringhurst, \textit{The Elements of Typographic Style}
\end{quotation}
...
\hfill--- Jost Hochuli, \textit{Detail in Typography}
\end{quotation}
