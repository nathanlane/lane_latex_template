...
\usepackage{../../paper/lltgridoverlay}  % Enable grid visualization
\usepackage{lipsum}
...
\safeparagraph{Paragraph Heading Level}
\lipsum[4][1-3]
...
\safeparagraph{Flexible Spacing}
