...
%% #48: the package no longer loads babel, and this fixture was getting it
%% for free. It matters here: the package's measured \spaceskip values were
%% tuned with babel present, so without it every one of these five pages
%% re-breaks. Loading it restores byte-identical output.
...
%% FIX: Force a new page so \academicdropcap has room; without it lettrine warns
%% "doesn't fit on page" when this section falls near the bottom of a page.
\clearpage
