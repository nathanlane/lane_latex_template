...
\safeparagraph{Mock Quote with Attribution}
\begingroup
\par\vspace{6.6pt}%
\leftskip=2em \rightskip=2em
\small \linespread{1.09}\selectfont \color[gray]{0.45}
\noindent
