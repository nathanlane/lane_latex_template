...
\item[{\textcolor[gray]{0.25}{\textbullet}}] Current gray bullet at 20\% gray (80\% black)
...
\item[Item separation] 3.3pt = \the\listquarterquantum
\item[Top/bottom space] 6.6pt = \the\listhalfquantum
\end{description}
