...
\safeparagraph{Paragraph Heading Test} This paragraph heading has 13.2pt before (1 unit) and 6.6pt after (0.5 unit). The text following should return to the grid.
